/**
 * Polos Worker for the Shared Queues example.
 *
 * Run with:
 *   npx tsx worker.ts
 *
 ...
 *   POLOS_DEPLOYMENT_ID - Deployment ID (default: shared-queues-examples)
 */
...
async function main() {
  ...
  const deploymentId = process.env['POLOS_DEPLOYMENT_ID'] ?? 'shared-queues-examples';
  ...
  console.log('Starting Shared Queues Examples worker...');

 ...
 *   POLOS_DEPLOYMENT_ID - Deployment ID (default: parallel-review-examples)
 */
...
async function main() {
  ...
  const deploymentId = process.env['POLOS_DEPLOYMENT_ID'] ?? 'parallel-review-examples';
  ...
  console.log('Starting Parallel Review Examples worker...');

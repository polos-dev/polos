/**
 * Worker for the approval page example.
 *
 * Run with:
 *   npx tsx worker.ts
 *
 ...
 *   POLOS_DEPLOYMENT_ID - Deployment ID (default: approval-page-example)
 */
...
async function main() {
  ...
  const deploymentId = process.env['POLOS_DEPLOYMENT_ID'] ?? 'approval-page-example';
  ...
  console.log('Starting Approval Page Example worker...');
  console.log(`  Project ID: ${projectId}`);
  console.log(`  Workflow:   ${deployWorkflow.id}`);

...
export const ToolTraceListPage: React.FC = () => {
  ...
  }, [toolId, selectedProjectId]);

  const fetchRuns = async (customFilters?: {
    startTime?: string;
    endTime?: string;
  }) => {
    if (!selectedProjectId || !toolId) return;
    ...
    return (
      <div className="flex items-center justify-center h-full">
        <div className="text-center">
          ...
          <p className="text-sm text-gray-500">Loading tool runs...</p>
        </div>
      </div>
    );
  }
  ...
  return (
    <div className="flex flex-col h-full bg-white overflow-hidden">
      ...
      <div className="p-3 border-b border-gray-200 bg-gray-50 flex items-center justify-between">
        <h1 className="text-lg font-semibold">Tool Runs</h1>
        <Button
          variant="ghost"
          size="sm"
